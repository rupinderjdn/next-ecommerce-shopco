        ...
        <div className="flex items-center flex-wrap justify-between">
          <div className="flex items-center space-x-[5px] xl:space-x-2.5">
            {data.discount.percentage > 0 ? (
              <span className="flex items-center font-bold text-black text-xl xl:text-2xl">
                <FaRupeeSign />
                {`${Math.round(
            ...
            {data.discount.percentage > 0 && (
              <span className="flex items-center font-bold text-black/40 line-through text-xl xl:text-2xl">
                <FaRupeeSign />
                {data.price}
              </span>
            )}
            ...
            {data.discount.percentage > 0 ? (
              <span className="flex items-center font-medium text-[10px] xl:text-xs py-1.5 px-3.5 rounded-full bg-[#FF3333]/10 text-[#FF3333]">
                <FaRupeeSign />
